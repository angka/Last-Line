...
exports.CRAFTING_RECIPES = exports.GATHERING_NODES = exports.MATERIALS = void 0;
...
exports.countMat = countMaterialsInInventory;
...
function getMaterial(id) {
    return exports.MATERIALS[id];
}
// ─── Gathering Nodes ──────────────────────────────────────────────────────────
exports.GATHERING_NODES = {
    whispering_plains: [
...
function getGatheringNodesForArea(areaId) {
    return exports.GATHERING_NODES[areaId] ?? [];
}
// ─── Crafting Recipes ─────────────────────────────────────────────────────────
