...
exports.getEnemyPool = getEnemyPool;
...
function getEnemyPool(levelRange) {
    return Object.values(exports.ENEMIES).filter(e => !e.isBoss && e.level >= levelRange[0] && e.level <= levelRange[1]);
}
