...
exports.ITEMS = exports.RARITY_RESET = exports.RARITY_COLORS = void 0;
...
function rarityColor(rarity) {
    return exports.RARITY_COLORS[rarity] ?? exports.RARITY_RESET;
}
function rarityName(rarity) {
    return `[${rarity.charAt(0).toUpperCase() + rarity.slice(1)}]`;
}
function formatItem(item, qty = 1) {
    const col = rarityColor(item.rarity);
    const r = exports.RARITY_RESET;
