...
exports.getDungeonTier = getDungeonTier;
exports.rollBossLoot = rollBossLoot;
exports.rollScrollDrops = rollScrollDrops;
exports.rollRegularLoot = rollRegularLoot;
exports.getDungeonChestLoot = getDungeonChestLoot;
...
// ─── Loot Rolling ─────────────────────────────────────────────────────────────
function rollLootEntry(entry, playerLuck) {
...
function rollBossLoot(bossId, playerLuck, defeatedBosses) {
...
function rollRegularLoot(playerLuck, enemyLevel) {
    const drops = [];
    // Small gold drop
    if (Math.random() < 0.60) {
...
function getRandomMaterialForLevel(level) {
...
function getDungeonChestLoot(dungeonId) {
...
// ─── Pending Loot Buffer ──────────────────────────────────────────────────────
function addLootToPending(current, newDrops) {
    const merged = {};
...
function resolveVictoryWithLoot(save, dungeonId, isBossKill) {
...
//# sourceMappingURL=LootEngine.js.map